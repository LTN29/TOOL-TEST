...
try{
  ...
  await connection.query(fs.readFileSync(path.join(root,'db/migrations/002_live_execution_safety.sql'),'utf8'));
  await connection.query(fs.readFileSync(path.join(root,'db/migrations/003_comment_groups.sql'),'utf8'));
